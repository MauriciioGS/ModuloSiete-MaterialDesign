...
import mx.mauriciogs.modulosiete.models.DataRv

class AdapterViewHolder(private val context: Context, private val data: List<DataRv>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val v=li.inflate(R.layout.item_data_rv,parent,false)
        return ViewHolder(v)
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.image.setImageResource(R.drawable.cat1)
